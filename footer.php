            ...
            <div class="copyright text-muted">
                <div class="container">
                    <?php if(get_theme_mod('hide_copyright') == ''){?>
                        <p class="pull-left">
                            <?php echo get_theme_mod( 'xylus_copyright', 'No copyright information has been saved yet.' ); ?>
                        </p>
                    <?php } if(get_theme_mod('hide_social') == ''){?>
                        <ul class="list-inline pull-right">
                            <?php if(get_theme_mod('xylus_facebook') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_facebook'); ?>">
                            ...
                            <?php } if(get_theme_mod('xylus_twitter') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_twitter'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_googleplus') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_googleplus'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_linkedin') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_linkedin'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_github') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_github'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_skype') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_skype'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_youtube') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_youtube'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_wordpress') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_wordpress'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_tumblr') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_tumblr'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <?php } if(get_theme_mod('xylus_pinterest') != ''){?>
                                <li>
                                    <a href="<?php echo get_theme_mod( 'xylus_pinterest'); ?>">
                                        <span class="fa-stack fa-lg">
                                            <i class="fa fa-circle fa-stack-2x"></i>
